> This `master` branch requires **Unity 2017.2** or a newer released version. For older or future versions of Unity please use a matching branch ([5.6](../../tree/5.6), [2017.1](../../tree/2017.1), [2018.1](../../tree/2018.1)).
